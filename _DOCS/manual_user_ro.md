# Manual de Utilizare - OpenRadioFM v.4.7 Beta Server

Bun venit la **OpenRadioFM v.4.7 Beta Server**, evoluția definitivă a radioului FM pentru unitățile Android (Head Units). Această versiune introduce capacități de streaming în cloud și gestionare a logo-urilor, optimizate pentru stabilitate și performanță maximă.
...
*Dezvoltat cu ❤️ de Jimmy80 pentru comunitatea Android Head Unit - v.4.7 Beta Server*
