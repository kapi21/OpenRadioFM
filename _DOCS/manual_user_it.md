# Manuale Utente - OpenRadioFM v.5.0.0-Beta Stability Edition

Benvenuti in **OpenRadioFM v.5.0.0-Beta Stability Edition**, l'evoluzione definitiva della radio FM per unità Android (Head Units). Questa versione introduce funzionalità di streaming e gestione dei loghi nel cloud, ottimizzate per la massima stabilità e prestazioni.
...
*Sviluppato con ❤️ da Jimmy80 per la comunità Android Head Unit - v.5.0.0-Beta Stability Edition*
