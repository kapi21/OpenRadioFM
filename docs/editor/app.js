...
const translations = {
    es: {
        ...
        optNightAutoHint: "Usa la casilla de arriba: desmarcada, el modo noche por horario está desactivado y no puedes editar las horas. Marcada, se activa y podrás ajustar inicio y fin.",
    ...
    en: {
        ...
        optNightAutoHint: "Use the checkbox above: when unchecked, scheduled night mode is off and you cannot edit the times. When checked, it turns on and you can set start and end.",
